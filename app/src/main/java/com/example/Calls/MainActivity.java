...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        try {
            ...
            listViewRecordsMA.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                @Override
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    try {
    ...
    private void loadListRecords() {
        try {
            ...
            recordService = new RecordsService(this);
    ...
    class ListContacts extends AsyncTask<Void, Void, Void> {

        @Override
        protected void onPreExecute() {
            super.onPreExecute();
            recordService = new RecordsService(MainActivity.this);
            listViewContactsMA.setVisibility(View.GONE);
        ...
        protected Void doInBackground(Void... voids) {
            try{
                ...
                ContactsService.generateFilteredListContacts(MainActivity.this);
            }catch (Exception e){
                e.printStackTrace();
            }
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            contactAdapter = new ContactAdapter(MainActivity.this, R.layout.list_contacts, ContactRepository.getListContacts());
            listViewContactsMA.setAdapter(contactAdapter);
            listViewContactsMA.setVisibility(View.VISIBLE);
